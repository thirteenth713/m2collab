...
$('.primator').slick({
prevArrow: '<button class="slick-arrow slick-prev"><img src="img/left-arrow.png"></button>',
 nextArrow: '<button class ="slick-arrow slick-next"><img src="img/right-arrow.svg"></button>',
